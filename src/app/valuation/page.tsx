...
async function VehicleResult({ values }: { values: ValuationFormValues }) {
  ...
  return (
    ...
    >
      {guideHref ? (
        <p className="text-sm">
          <Link href={guideHref} className="inline-flex items-center gap-1 text-info underline underline-offset-4 hover:no-underline">
    ...
    >
      <p className="text-sm">
        <Link
          ...
          className="inline-flex items-center gap-1 text-info underline underline-offset-4 hover:no-underline"
        >
