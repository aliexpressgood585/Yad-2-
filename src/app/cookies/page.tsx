...
const COOKIES = [
  ...
  {
    name: "theme",
    purpose: "זכירת בחירת מצב התצוגה — בהיר, לילה או לפי המערכת.",
    duration: "שנה",
    type: "העדפה",
  },
  {
...
export default function CookiesPage() {
  return (
    <ContentPage
      title="מדיניות עוגיות"
      intro="אנחנו משתמשים בעוגיות הכרחיות ובאחסון מקומי בלבד. אין באתר עוגיות מעקב פרסומיות של צד שלישי."
