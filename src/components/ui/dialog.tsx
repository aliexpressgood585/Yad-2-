  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-h-[92dvh] overflow-y-auto border border-border bg-background p-5 shadow-pop sm:rounded-lg",
...
>(({ className, children, side = "end", ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex flex-col gap-4 border-border bg-background shadow-pop",
